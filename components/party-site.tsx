...
export function PartySite() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#fffaf5] text-[#3d3145]">
      ...
      <footer className="border-t border-[#3d3145]/10 px-5 py-8 lg:px-10"><div className="mx-auto flex max-w-7xl flex-col gap-5 text-sm text-[#3d3145]/60 sm:flex-row sm:items-center sm:justify-evenly"><span className="font-display text-xl font-bold text-[#e85d7b]">[NOME].</span><span>{t.footer}</span><a href="https://instagram.com/donali.party" target="_blank" rel="noreferrer" aria-label="Instagram Donali Party" className="text-[#e85d7b] transition hover:scale-110 hover:text-[#d94e6d]"><svg aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none" /></svg></a></div></footer>
